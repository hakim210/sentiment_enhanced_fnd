...
1. Ethical Journalism Network, "What is Fake News?," [Online]. Available: https://ethicaljournalismnetwork.org/resources/publications/ejn-report-on-fake-news
1. PolitiFact, "PolitiFact Statements Dataset," [Online]. Available: https://www.politifact.com/
1. A. K. Dey, S. Saha, and S. Saha, "Sentiment Analysis for Fake News Detection by Means of Neural Networks," *Journal of Biomedical Informatics*, vol. 109, p. 103514, 2020.
1. M. Yang, L. Flores, H. Hunma, and B. Trevisan, "Exploring the Impact of Sentiment Analysis on Current Methods of Fake News Detection," *Yale Undergraduate Research Journal*, vol. 3, no. 1, 2022.
1. A. Kuila and S. Sarkar, "Deciphering Political Entity Sentiment in News with Large Language Models: Zero-Shot and Few-Shot Strategies," in *Proceedings of the 4th Workshop on NLP for Political Text (PoliticalNLP 2024)*, 2024.
1. S. Roy, D. Paul, and C. Das, "Fake News Detection: Comparative Evaluation of BERT-like Models and Large Language Models with Generative AI-Annotated Data," *arXiv preprint arXiv:2412.14276*, 2024.
1. S. Bondielli and F. Marcelloni, "Sentiment Analysis for Fake News Detection," *ProQuest*, 2021.
...
1. ISOT Research Lab, "ISOT Fake News Dataset," [Online]. Available: https://www.uvic.ca/engineering/ece/isot/datasets/fake-news/index.php
1. A. J. Bidgoly, "FNID: Fake News Inference Dataset," *IEEE DataPort*, 2020.
1. S. V. Balshetwar, R. S. Abilash, and R. D. Jermisha, "Fake news detection in social media based on sentiment analysis using classifier techniques," *Multimedia Tools and Applications*, vol. 82, pp. 18653–18678, 2023.
1. I. K. Sastrawan, I. P. A. Bayupati, and D. M. S. Arsa, "Detection of fake news using deep learning CNN–RNN based methods," *ICT Express*, vol. 8, no. 3, pp. 354–360, 2022.
1. A. Saha, T. Khondakar, M. B. Miah, S. A. Ahsan, and D. Nandi, "A Comparative Analysis on Fake News Detection Methods," in *Proceedings of the 2022 International Conference on Computer, Communication, Chemical, Material and Electronic Engineering (IC4ME2)*, 2022, pp. 1–6.
1. "A Semi-supervised Fake News Detection using Sentiment Encoding," *arXiv preprint arXiv:2407.19332*, 2024.
1. "Domain Adaptive Fake News Detection via Reinforcement Learning," *arXiv preprint arXiv:2202.08159*, 2024.
1. "Cross-Domain Fake News Detection based on Dual-Granularity Adversarial Training," in *Proceedings of the 29th International Conference on Computational Linguistics (COLING 2025)*, 2025.
